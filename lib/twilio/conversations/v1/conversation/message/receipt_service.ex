...
defmodule Twilio.Conversations.V1.Conversation.Message.ReceiptService do
  @moduledoc """
  ...
  def list(client, conversation_sid, message_sid, params \\ %{}, opts \\ []) do
    case Client.request(
           client,
           :get,
  ...
  def stream(client, conversation_sid, message_sid, params \\ %{}, opts \\ []) do
    Twilio.Page.stream(
      fn page_opts ->
        list(client, conversation_sid, message_sid, Map.merge(params, page_opts), opts)
      end,
      "delivery_receipts"
    )
  end
  ...
  @spec fetch(Client.t(), String.t(), String.t(), String.t(), keyword()) ::
          {:ok, Twilio.Resources.Conversations.V1.Conversation.Message.Receipt.t()}
          | {:ok, map(), map()}
          | :ok
          | {:error, Twilio.Error.t()}
  def fetch(client, conversation_sid, message_sid, sid, opts \\ []) do
    with {:ok, data} <-
           Client.request(
             client,
             :get,
