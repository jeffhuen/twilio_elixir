...
defmodule Twilio.Conversations.V1.ConversationService do
  @moduledoc """
         ...
         %{
           ...
           | items:
               Deserializer.deserialize_list(
                 page.items,
                 Twilio.Resources.Conversations.V1.Conversation
               )
         }}
  ...
  @doc "Stream: Retrieve a list of conversations in your account's default service (lazy auto-pagination)."
  ...
  @spec create(Client.t(), map(), keyword()) ::
          {:ok, Twilio.Resources.Conversations.V1.Conversation.t()} | {:error, Twilio.Error.t()}
