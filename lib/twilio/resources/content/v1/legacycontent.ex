...
defmodule Twilio.Resources.Content.V1.Legacycontent do
  @moduledoc """
  ...
  | `legacy_body` | The string body field of the legacy content template associated with this Content resource |
  | `legacy_template_name` | The string name of the legacy content template associated with this Content resource, unique across all template names for its account.  Only lowercase letters, numbers and underscores are allowed |
  ...
  @object_name "content.v1.legacy_content"
