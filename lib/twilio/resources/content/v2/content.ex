...
defmodule Twilio.Resources.Content.V2.Content do
  @moduledoc """
  ...
  ## Sub-resources
  - `approval_create` — `/v1/Content/{sid}/ApprovalRequests/whatsapp`
  - `approval_fetch` — `/v1/Content/{sid}/ApprovalRequests`
