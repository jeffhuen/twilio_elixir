...
defmodule Twilio.Resources.Preview.Marketplace.Availableaddon do
  @moduledoc """
  ...
  ## Sub-resources
  - `extensions` — `/marketplace/AvailableAddOns/{available_add_on_sid}/Extensions`
  ...
  @type t :: %__MODULE__{
          configuration_schema: String.t() | nil,
  ...
  @object_name "preview.marketplace.available_add_on"
