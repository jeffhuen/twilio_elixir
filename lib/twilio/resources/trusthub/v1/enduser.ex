...
defmodule Twilio.Resources.Trusthub.V1.Enduser do
  @moduledoc """
  Enduser resource.
  ...
  | `type` | The type of end user of the Bundle resource - can be `individual` or `business`. |
  ...
  @object_name "trusthub.v1.end_user"
