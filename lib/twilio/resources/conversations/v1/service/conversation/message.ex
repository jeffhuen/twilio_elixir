...
defmodule Twilio.Resources.Conversations.V1.Service.Conversation.Message do
  @moduledoc """
  ...
  | `url` | An absolute API resource URL for this message.. Format: uri |
  """
  ...
  @object_name "conversations.v1.service.service_conversation.service_conversation_message"
