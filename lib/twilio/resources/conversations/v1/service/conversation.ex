...
defmodule Twilio.Resources.Conversations.V1.Service.Conversation do
  @moduledoc """
  ...
  ## Sub-resources
  - `export` — `/v1/Services/{chat_service_sid}/Conversations/{conversation_sid}/Export`
  - `messages` — `/v1/Services/{chat_service_sid}/Conversations/{conversation_sid}/Messages`
  - `participants` — `/v1/Services/{chat_service_sid}/Conversations/{conversation_sid}/Participants`
  - `webhooks` — `/v1/Services/{chat_service_sid}/Conversations/{conversation_sid}/Webhooks`
  ...
  # credo:disable-for-next-line Credo.Check.Readability.MaxLineLength
  | `state` | Current state of this conversation. Can be either `initializing`, `active`, `inactive` or `closed` and defaults to `active`. Values: `inactive`, `active`, `closed`, `initializing` |
  ...
  @object_name "conversations.v1.service.service_conversation"
