...
defmodule Twilio.Resources.Conversations.V1.Conversation do
  @moduledoc """
  ...
  ## Sub-resources
  - `export` — `/v1/Conversations/{conversation_sid}/Export`
  - `messages` — `/v1/Conversations/{conversation_sid}/Messages`
  - `participants` — `/v1/Conversations/{conversation_sid}/Participants`
  - `webhooks` — `/v1/Conversations/{conversation_sid}/Webhooks`
  ...
  @object_name "conversations.v1.conversation"
