...
defmodule Twilio.Resources.Numbers.V2.Regulatorycompliance.Bundle do
  @moduledoc """
  Bundle resource.
  ...
  ## Sub-resources
  - `bundle_copies` — `/v2/RegulatoryCompliance/Bundles/{bundle_sid}/Copies`
  - `evaluations` — `/v2/RegulatoryCompliance/Bundles/{bundle_sid}/Evaluations`
  - `item_assignments` — `/v2/RegulatoryCompliance/Bundles/{bundle_sid}/ItemAssignments`
  - `replace_items` — `/v2/RegulatoryCompliance/Bundles/{bundle_sid}/ReplaceItems`
  ...
  | `links` | The URLs of the Assigned Items of the Bundle resource.. Format: uri-map |
  ...
  | `url` | The absolute URL of the Bundle resource.. Format: uri |
  # credo:disable-for-next-line Credo.Check.Readability.MaxLineLength
  ...
  @object_name "numbers.v2.regulatory_compliance.bundle"
