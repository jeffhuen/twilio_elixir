...
defmodule Twilio.Resources.Flex.V1.Pluginservice.Configuration.Archive do
  @moduledoc """
  ...
  defstruct [:account_sid, :archived, :date_created, :description, :name, :sid, :url]

  @object_name "flex.v1.plugin_configuration_archive"
