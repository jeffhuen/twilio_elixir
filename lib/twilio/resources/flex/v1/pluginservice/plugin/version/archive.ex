...
defmodule Twilio.Resources.Flex.V1.Pluginservice.Plugin.Version.Archive do
  @moduledoc """
  Archive resource.
  ...
  | `private` | Whether to inject credentials while accessing this Plugin Version. The default value is false. |
  ...
  @object_name "flex.v1.plugin_version_archive"
