...
defmodule Twilio.Resources.Api.V2010.Incomingphonenumber do
  @moduledoc """
  ...
  ## Sub-resources
  - `assigned_add_ons` — `/2010-04-01/Accounts/{account_sid}/IncomingPhoneNumbers/{resource_sid}/AssignedAddOns.json`
  ...
  # credo:disable-for-next-line Credo.Check.Readability.MaxLineLength
  | `account_sid` | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created this IncomingPhoneNumber resource. |
  # credo:disable-for-next-line Credo.Check.Readability.MaxLineLength
  ...
  | `sid` | The unique string that that we created to identify this IncomingPhoneNumber resource. |
  ...
  @object_name "api.v2010.account.incoming_phone_number"
