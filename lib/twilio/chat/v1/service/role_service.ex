...
defmodule Twilio.Chat.V1.Service.RoleService do
  @moduledoc """
      ...
      {:ok, data} ->
        ...
        {:ok,
         %{
           page
           | items:
               Deserializer.deserialize_list(page.items, Twilio.Resources.Chat.V1.Service.Role)
         }}
  ...
  @spec create(Client.t(), String.t(), map(), keyword()) ::
          {:ok, Twilio.Resources.Chat.V1.Service.Role.t()} | {:error, Twilio.Error.t()}
  def create(client, service_sid, params \\ %{}, opts \\ []) do
    with {:ok, data} <-
      ...
      {:ok, Deserializer.deserialize(data, Twilio.Resources.Chat.V1.Service.Role)}
    end
  end
