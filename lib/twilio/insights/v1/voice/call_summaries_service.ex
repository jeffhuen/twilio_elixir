...
defmodule Twilio.Insights.V1.Voice.CallSummariesService do
  @moduledoc """
  ...
  def list(client, params \\ %{}, opts \\ []) do
    case Client.request(client, :get, "/v1/Voice/Summaries",
           params: params,
           opts: opts,
           base_url: "https://insights.twilio.com"
         ) do
      {:ok, data} ->
        page = Twilio.Page.from_response(data, "call_summaries")
         ...
         %{
           ...
           | items:
               Deserializer.deserialize_list(
                 page.items,
                 Twilio.Resources.Insights.V1.Voice.CallSummaries
               )
         }}
  ...
  @doc "Stream: Get a list of Call Summaries. (lazy auto-pagination)."
