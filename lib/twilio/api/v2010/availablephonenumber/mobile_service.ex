...
defmodule Twilio.Api.V2010.Availablephonenumber.MobileService do
  @moduledoc """
  ...
  Operation: `ListAvailablePhoneNumberMobile` | Tags: Api20100401Mobile
  ...
  def list(client, country_code, params \\ %{}, opts \\ []) do
    case Client.request(
           client,
           :get,
           "/2010-04-01/Accounts/#{client.account_sid}/AvailablePhoneNumbers/#{country_code}/Mobile.json",
           params: params,
           opts: opts,
