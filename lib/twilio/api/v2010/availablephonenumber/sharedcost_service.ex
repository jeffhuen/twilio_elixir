...
defmodule Twilio.Api.V2010.Availablephonenumber.SharedcostService do
  @moduledoc """
  ...
  Operation: `ListAvailablePhoneNumberSharedCost` | Tags: Api20100401SharedCost
  ...
  def list(client, country_code, params \\ %{}, opts \\ []) do
    case Client.request(
           client,
           :get,
           "/2010-04-01/Accounts/#{client.account_sid}/AvailablePhoneNumbers/#{country_code}/SharedCost.json",
           params: params,
           opts: opts,
