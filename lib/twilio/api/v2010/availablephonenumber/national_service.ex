...
defmodule Twilio.Api.V2010.Availablephonenumber.NationalService do
  @moduledoc """
  ...
  Operation: `ListAvailablePhoneNumberNational` | Tags: Api20100401National
  ...
  def list(client, country_code, params \\ %{}, opts \\ []) do
    case Client.request(
           client,
           :get,
           "/2010-04-01/Accounts/#{client.account_sid}/AvailablePhoneNumbers/#{country_code}/National.json",
           params: params,
           opts: opts,
