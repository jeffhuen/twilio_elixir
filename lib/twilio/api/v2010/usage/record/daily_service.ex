...
defmodule Twilio.Api.V2010.Usage.Record.DailyService do
  @moduledoc """
  ...
  Operation: `ListUsageRecordDaily` | Tags: Api20100401Daily
  ...
  def list(client, params \\ %{}, opts \\ []) do
    case Client.request(
           client,
           :get,
           "/2010-04-01/Accounts/#{client.account_sid}/Usage/Records/Daily.json",
           params: params,
           opts: opts,
