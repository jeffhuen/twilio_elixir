...
defmodule Twilio.Api.V2010.Usage.Record.AlltimeService do
  @moduledoc """
  ...
  Operation: `ListUsageRecordAllTime` | Tags: Api20100401AllTime
  ...
  def list(client, params \\ %{}, opts \\ []) do
    case Client.request(
           client,
           :get,
           "/2010-04-01/Accounts/#{client.account_sid}/Usage/Records/AllTime.json",
           params: params,
           opts: opts,
