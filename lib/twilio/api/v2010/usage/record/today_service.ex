...
defmodule Twilio.Api.V2010.Usage.Record.TodayService do
  @moduledoc """
  ...
  Operation: `ListUsageRecordToday` | Tags: Api20100401Today
  ...
  def list(client, params \\ %{}, opts \\ []) do
    case Client.request(
           client,
           :get,
           "/2010-04-01/Accounts/#{client.account_sid}/Usage/Records/Today.json",
           params: params,
           opts: opts,
