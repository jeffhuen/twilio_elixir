...
defmodule Twilio.Api.V2010.Usage.Record.LastMonthService do
  @moduledoc """
  ...
  Operation: `ListUsageRecordLastMonth` | Tags: Api20100401LastMonth
  ...
  def list(client, params \\ %{}, opts \\ []) do
    case Client.request(
           client,
           :get,
           "/2010-04-01/Accounts/#{client.account_sid}/Usage/Records/LastMonth.json",
           params: params,
           opts: opts,
