...
defmodule Twilio.Api.V2010.Usage.RecordService do
  @moduledoc """
  ...
  Operation: `ListUsageRecord` | Tags: Api20100401Record
  ...
  def list(client, params \\ %{}, opts \\ []) do
    case Client.request(
           client,
           :get,
           "/2010-04-01/Accounts/#{client.account_sid}/Usage/Records.json",
           params: params,
           opts: opts,
      ...
      {:ok, data} ->
        ...
        {:ok,
         %{
           page
           | items:
               Deserializer.deserialize_list(page.items, Twilio.Resources.Api.V2010.Usage.Record)
         }}
  ...
  # credo:disable-for-next-line Credo.Check.Readability.MaxLineLength
  @doc "Stream: Retrieve a list of usage-records belonging to the account used to make the request (lazy auto-pagination)."
