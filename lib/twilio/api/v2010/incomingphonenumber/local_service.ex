...
defmodule Twilio.Api.V2010.Incomingphonenumber.LocalService do
  @moduledoc """
  ...
  def list(client, params \\ %{}, opts \\ []) do
    case Client.request(
           client,
           :get,
           "/2010-04-01/Accounts/#{client.account_sid}/IncomingPhoneNumbers/Local.json",
           params: params,
           opts: opts,
  ...
  @spec create(Client.t(), map(), keyword()) ::
          {:ok, Twilio.Resources.Api.V2010.Incomingphonenumber.Local.t()}
  ...
  def create(client, params \\ %{}, opts \\ []) do
    with {:ok, data} <-
      ...
      {:ok, Deserializer.deserialize(data, Twilio.Resources.Api.V2010.Incomingphonenumber.Local)}
    end
  end
end
