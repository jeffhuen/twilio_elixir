...
defmodule Twilio.Api.V2010.Incomingphonenumber.TollfreeService do
  @moduledoc """
  ...
  Operation: `ListIncomingPhoneNumberTollFree` | Tags: Api20100401IncomingPhoneNumberTollFree
  ...
  def list(client, params \\ %{}, opts \\ []) do
    case Client.request(
           client,
           :get,
           "/2010-04-01/Accounts/#{client.account_sid}/IncomingPhoneNumbers/TollFree.json",
           params: params,
           opts: opts,
  ...
  Operation: `CreateIncomingPhoneNumberTollFree` | Tags: Api20100401IncomingPhoneNumberTollFree
  ...
  @spec create(Client.t(), map(), keyword()) ::
          {:ok, Twilio.Resources.Api.V2010.Incomingphonenumber.Tollfree.t()}
  ...
  def create(client, params \\ %{}, opts \\ []) do
    with {:ok, data} <-
      ...
      {:ok,
       Deserializer.deserialize(data, Twilio.Resources.Api.V2010.Incomingphonenumber.Tollfree)}
    end
  end
end
