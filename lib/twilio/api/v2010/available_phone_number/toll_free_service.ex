...
defmodule Twilio.Api.V2010.AvailablePhoneNumber.TollFreeService do
  @moduledoc """
  ...
  Operation: `ListAvailablePhoneNumberTollFree` | Tags: Api20100401TollFree
  ...
  def list(client, country_code, params \\ %{}, opts \\ []) do
    case Client.request(
           client,
           :get,
           "/2010-04-01/Accounts/#{client.account_sid}/AvailablePhoneNumbers/#{country_code}/TollFree.json",
           params: params,
           opts: opts,
