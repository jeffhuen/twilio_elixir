...
defmodule Twilio.Taskrouter.V1.Workspace.Workflow.WorkflowCumulativeStatisticsService do
  @moduledoc """
  ...
  Operation: `FetchWorkflowCumulativeStatistics` | Tags: TaskrouterV1WorkflowCumulativeStatistics
  ...
  @spec fetch(Client.t(), String.t(), String.t(), keyword()) ::
          {:ok,
           Twilio.Resources.Taskrouter.V1.Workspace.Workflow.WorkflowCumulativeStatistics.t()}
          | {:ok, map(), map()}
          | :ok
  ...
  def fetch(client, workspace_sid, workflow_sid, opts \\ []) do
    with {:ok, data} <-
           Client.request(
             client,
             :get,
             "/v1/Workspaces/#{workspace_sid}/Workflows/#{workflow_sid}/CumulativeStatistics",
             opts: opts,
