...
defmodule Twilio.Taskrouter.V1.Workspace.WorkspaceCumulativeStatisticsService do
  @moduledoc """
  ...
  Operation: `FetchWorkspaceCumulativeStatistics` | Tags: TaskrouterV1WorkspaceCumulativeStatistics
  ...
  @spec fetch(Client.t(), String.t(), keyword()) ::
          {:ok, Twilio.Resources.Taskrouter.V1.Workspace.WorkspaceCumulativeStatistics.t()}
